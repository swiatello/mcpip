...
WebUI.click(findTestObject('Ogloszenie/Ogloszenie_1_2/h3_556203-N-2018 - Przetarg Te-nowy'))

WebUI.click(findTestObject('Ogloszenie/Ogloszenie_1_2/a_kartaogloszenia'))
